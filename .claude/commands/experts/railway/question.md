...
description: Answer questions about railway domain without coding
argument-hint: [question]
---

# railway Expert - Question Mode

Answer the user's question by analyzing railway implementation and patterns in this codebase. This prompt provides information without making code changes.

## Variables

USER_QUESTION: $1
EXPERTISE_PATH: .claude/commands/experts/railway/expertise.yaml

## Instructions

- IMPORTANT: This is a question-answering task only - DO NOT write, edit, or create any files
- Focus on railway-related functionality
...
- Read the `EXPERTISE_PATH` file to understand railway architecture and patterns
