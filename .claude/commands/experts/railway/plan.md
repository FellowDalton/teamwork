...
description: Create railway-focused implementation plan using expertise context
argument-hint: [user_request]
---

# Purpose

You are operating a Higher Order Prompt (HOP) that creates implementation plans with railway expertise. Load expertise before delegating to `/plan`.
...
2. **Execute Planning with Context**
   ...
   - Prioritize railway elements in the plan
