...
description: Consolidate websocket expertise learnings journal into expertise.yaml
---

# Purpose

Apply accumulated learnings from the JSONL journal into the websocket expertise YAML file.
