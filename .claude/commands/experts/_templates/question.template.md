...
description: Answer questions about {EXPERT} domain without coding
argument-hint: [question]
---

# {EXPERT} Expert - Question Mode

Answer the user's question by analyzing {EXPERT} implementation and patterns in this codebase. This prompt provides information without making code changes.

## Variables

USER_QUESTION: $1
EXPERTISE_PATH: .claude/commands/experts/{EXPERT}/expertise.yaml

## Instructions

- IMPORTANT: This is a question-answering task only - DO NOT write, edit, or create any files
- Focus on {EXPERT}-related functionality
...
- Read the `EXPERTISE_PATH` file to understand {EXPERT} architecture and patterns
