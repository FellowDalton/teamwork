...
description: Consolidate {EXPERT} expertise learnings journal into expertise.yaml
---

# Purpose

Apply accumulated learnings from the JSONL journal into the {EXPERT} expertise YAML file.
